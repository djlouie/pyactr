...
if __name__ == "__main__":
    ...
    for i in range(5):
        ...
        ##############################################################################
        # Uncomment the following if you want to see the randomly generated stimulus #
        ##############################################################################
        # print(text)
        ...
        sim = m.m.simulation(realtime=True, trace=True,  gui=False, environment_process=environ.environment_process, stimuli=2*text, triggers=4*trigger,times=5)
        sim.run(12)

        ########################################################
        # Uncomment the following if you want to print results #
        ########################################################
        # print(m.dm)
